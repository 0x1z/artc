...
yay -S layan-kde-git spotify-adblock google-chrome brave-bin visual-studio-code-bin sublime-text-4 nerd-fonts-fantasque-sans-mono ttf-meslo-nerd-font-powerlevel10k ttf-joypixels
